...
public class verifyLoadAllotmentForSeasonA_TC01 extends BaseClass {
	loginPage login;
	File myFile;
	...
	public void loginToApp() throws EncryptedDocumentException, IOException, InterruptedException
	{
        ...
        UtilityClass.listBoxHandlingUsingByText("HK005 - (TESTING)", accommodationNew.clickOnTBMCodeSelection());
        ...
        UtilityClass.implicitlyWaitInMillis(12000);
            ...
            dashboard.clickOnOfferdefination();
      		...
      		offerdefination.SendTBMcode(UtilityClass.readDataFromStringExcel(55, 2, "Sheet5"));
      		Thread.sleep(4200);
    	    ...
    	    accommdationList.sendTbmCodeField(UtilityClass.readDataFromStringExcel(55, 2, "Sheet5"));
    	    Thread.sleep(2000);
    ...
    @Test 
    public void validateAllotmentForSeasonADates() throws EncryptedDocumentException, IOException 
    {
	  ...
	  Reporter.log("Validating Actual allotment number on Price page for season_A in contracts is "+Actualseason_Aallot+" and Expected initial allotment number for season_A on Allotment page is "+Allot_Ainitial,true);
	  ...
	  Reporter.log("Validating Actual allotment number on Price page for season_A in contracts is "+Actualseason_Aallot+" and Expected current allotment number for season_A on Allotment page is "+Allot_Acurrent,true);
	  ...
	  Reporter.log("Validating Actual allotment number on Price page for season_A in contracts is "+Actualseason_Aallot+" and Expected Remaining allotment number for season_A on Allotment page is "+Allot_ARemaining,true);
   }
