...
public class verifyReleaseDaysTC19 extends BaseClass {
	...
	public void validateReleaseDays() throws EncryptedDocumentException, IOException, InterruptedException {
    	...
    	Thread.sleep(1000);  	
   	    ...
   	    Thread.sleep(500);
    	ChangeAllotment.sendDateUntilTo1Field(UtilityClass.readDataFromStringExcel(150, 1, "Sheet5"));
    	Reporter.log("Enter until date for room1",true);
    	Thread.sleep(1000);
    	UtilityClass.implicitlyWaitInsec(70);
    	ChangeAllotment.sendReleaseDaysField(UtilityClass.readDataFromStringExcel(151, 1, "Sheet5"));
    	Thread.sleep(500);
