	...
	public class TCC26 extends baseClass
	{
		loginPage login;
		File myFile;
		...
		public void loginToApp() throws EncryptedDocumentException, IOException, InterruptedException
		{
			...
			Thread.sleep(9500); 
	            ...
	            BookingMask.ClearbookingActionfield();
	            utilityClass.implicitlyWaitInMillis(40000);
	    		BookingMask.sendBookingAction(utilityClass.readDataFromStringExcel(60, 2, "Sheet3"));
	    		Thread.sleep(1000);
	    		bookingupdate.clearRoomcode1();
	    		bookingupdate.sendRoomcode1(utilityClass.readDataFromStringExcel(63, 2, "Sheet3"));
	   ...
	   @Test
	   public void validateErrorMsgByInvalidRoomcode() throws EncryptedDocumentException, IOException 
	  
	   	{
		    String ActualMessage = BookingMask.getMultisalesLinesBookingErrorMsgWithExceedMaxStay();
		    String expectedMessage = utilityClass.readDataFromStringExcel(64, 2, "Sheet3");
		    Assert.assertEquals(expectedMessage,ActualMessage, "TC failed as Actual message and expected message are not matching ");
		    Reporter.log("Validating Actual message "+BookingMask.getMultisalesLinesBookingErrorMsgWithExceedMaxStay()+" and Expected message "+utilityClass.readDataFromStringExcel(64, 2, "Sheet3"),true);
		}
