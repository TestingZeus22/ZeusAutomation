...
public class TCC12 extends baseClass {
	loginPage login;
	File myFile;
...
//      		Thread.sleep(1500);
    	    ...
    	    //driver.findElement(By.xpath("//a[@id='j1_33_anchor']")).click();
    	    ...
    	    try {
				...
				System.out.println("click on Room1");
			}
    		...
    		driver.findElement(By.xpath("(//ul[@class='jstree-children']//a)[30]")).click();
    		//driver.findElement(By.xpath("//a[@id='j3_33_anchor']")).click();
    		...
    		BookingMask.sendTravelFromDate(utilityClass.readDataFromStringExcel(117, 1, "Sheet2"));
    		Reporter.log("Send Travel from date",true);
    		
    		BookingMask.sendTravelToDate(utilityClass.readDataFromStringExcel(118, 1, "Sheet2"));
    ...
    @Test
    public void validateTravelToDateOutOfContactDurationErrorMessage() throws EncryptedDocumentException, IOException 
    {
    	String ActualMessage = BookingMask.getTravelToDateOutOfContractDateNotification();
	    String expectedMessage = utilityClass.readDataFromStringExcel(116, 1, "Sheet2");
	    Assert.assertEquals(ActualMessage, expectedMessage,"Test Case Failed as actual & expected Message are not matching");
	    Reporter.log("Validating Actual message "+BookingMask.getTravelToDateOutOfContractDateNotification()+" and Expected message "+utilityClass.readDataFromStringExcel(116, 1, "Sheet2"),true);
    }
