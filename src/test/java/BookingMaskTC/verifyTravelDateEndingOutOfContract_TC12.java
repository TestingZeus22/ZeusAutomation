...
public class verifyTravelDateEndingOutOfContract_TC12 extends baseClass {
	...
	public void loginToApp() throws EncryptedDocumentException, IOException, InterruptedException
	{
    		...
    		BookingMask.sendTravelFromDate(utilityClass.readDataFromStringExcel(126, 1, "Sheet2"));
    		Reporter.log("Send Travel from date",true);
    		
    		BookingMask.sendTravelToDate(utilityClass.readDataFromStringExcel(127, 1, "Sheet2"));
    ...
    public void validateMessageOnBMpage() throws EncryptedDocumentException, IOException 
    {
	    ...
	    String expectedMessage = utilityClass.readDataFromStringExcel(125, 1, "Sheet2");
	    ...
	    Reporter.log("Validating Actual message "+BookingMask.getTravelToDateOutOfContractDateNotification()+" and Expected message "+utilityClass.readDataFromStringExcel(125, 1, "Sheet2"),true);
    }
