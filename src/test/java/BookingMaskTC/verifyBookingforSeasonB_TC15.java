...
public class verifyBookingforSeasonB_TC15 extends baseClass {
    ...
    public void validatePriceForSeasonB() throws EncryptedDocumentException, IOException 
    {
	  ...
	  String expectedPrice = utilityClass.readDataFromStringExcel(80, 1, "Sheet2");
	  Assert.assertEquals(ActualPrice, expectedPrice,"Test Case Failed as actual & expected Price are not matching");
	  Reporter.log("Validating Actual price "+BookingMask.getPriceFieldValue1("value")+" and Expected Price "+utilityClass.readDataFromStringExcel(80, 1, "Sheet2"),true);
    }
