	...
	public class TCC23 extends baseClass
	{
		loginPage login;
		File myFile;
		...
		public void loginToApp() throws EncryptedDocumentException, IOException, InterruptedException
		{
			...
			Thread.sleep(9500); 
	    		...
	    		BookingMask.sendTravelFromDate(utilityClass.readDataFromStringExcel(52, 1, "Sheet3"));
	    		Reporter.log("Send Travel from date for Season-G",true);
	    		
	    		BookingMask.sendTravelToDate(utilityClass.readDataFromStringExcel(53, 1, "Sheet3"));
	            ...
	            BookingMask.ClearbookingActionfield();
	            utilityClass.implicitlyWaitInMillis(40000);
	    		BookingMask.sendBookingAction(utilityClass.readDataFromStringExcel(51, 1, "Sheet3"));
	    		utilityClass.implicitlyWaitInMillis(20000);
	    		bookingupdate.clearTravelFrom1();
	    		bookingupdate.sendTravelFrom1(utilityClass.readDataFromStringExcel(54, 1, "Sheet3"));
	    		Reporter.log("Send Modified Travel from date",true);
	    		utilityClass.implicitlyWaitInMillis(20000);
	    		bookingupdate.clearTravelTo1();
	    		bookingupdate.sendTravelTo1(utilityClass.readDataFromStringExcel(55, 1, "Sheet3"));
...
//				utilityClass.implicitlyWaitInMillis(20000);
	   ...
	   public void validatePriceByEditingBothTravelFromAndToDate() throws EncryptedDocumentException, IOException 
		   ...
		   String expectedPrice = utilityClass.readDataFromStringExcel(56, 1, "Sheet3");
		   Assert.assertEquals(ActualPrice, expectedPrice,"Test Case Failed as actual & expected Price are not matching");
		   Reporter.log("Validating Actual price "+bookingupdate.getPriceFieldValue1("value")+" and Expected Price "+utilityClass.readDataFromStringExcel(56, 1, "Sheet3"),true); 
		}
