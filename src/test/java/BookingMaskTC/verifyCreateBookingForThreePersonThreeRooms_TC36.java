	...
	public class verifyCreateBookingForThreePersonThreeRooms_TC36 extends baseClass
	{
		...
		public void loginToApp() throws EncryptedDocumentException, IOException, InterruptedException
		{
	    		...
	    		BookingMask.sendNoOfPax(utilityClass.readDataFromStringExcel(187, 1, "Sheet2"));
	    		...
	    		Reporter.log("Send roomcode2 in input field",true);
	    		...
	    		BookingMask.sendTravelFromDate2(utilityClass.readDataFromStringExcel(81, 1, "Sheet2"));
	    		Reporter.log("Send Travel from date for Season-C",true);
	    		
	    		BookingMask.sendTravelToDate2(utilityClass.readDataFromStringExcel(82, 1, "Sheet2"));
	    		Reporter.log("Send Travel To date for Season-C",true);
	    		
	    		BookingMask.sendPassenger2(utilityClass.readDataFromStringExcel(184, 2, "Sheet2"));
	    		Reporter.log("Select Number of passenger",true);
	    		
	    		BookingMask.sendKOS3(utilityClass.readDataFromStringExcel(68, 1, "Sheet2"));
	    		Reporter.log("Send correct KOS2 in input field",true);
	    		utilityClass.implicitlyWaitInMillis(1000);
	    		
	    		BookingMask.sendproductCode3(utilityClass.readDataFromStringExcel(69, 1, "Sheet2"));
	    		Reporter.log("Send correct ProductCode in input field",true);
	    		utilityClass.implicitlyWaitInMillis(1000);
	    		
	    		BookingMask.sendRoomCode3(utilityClass.readDataFromStringExcel(70, 1, "Sheet2"));
	    		Reporter.log("Send roomcode in input field",true);
	    		
	    		BookingMask.sendBoard3(utilityClass.readDataFromStringExcel(71, 1, "Sheet2"));
	    		Reporter.log("Send correct boardName",true);
	    		
	    		BookingMask.sendOccupancy3(utilityClass.readDataFromStringExcel(182, 3, "Sheet2"));
	    		Reporter.log("Send Occupancy",true);
	    	
	    		BookingMask.sendTotalPax3(utilityClass.readDataFromStringExcel(183, 3, "Sheet2"));
	    		Reporter.log("Send bookinglines ",true);
	    		
	    		BookingMask.sendTravelFromDate3(utilityClass.readDataFromStringExcel(81, 1, "Sheet2"));
	    		Reporter.log("Send Travel from date for Season-C",true);
	    		
	    		BookingMask.sendTravelToDate3(utilityClass.readDataFromStringExcel(82, 1, "Sheet2"));
	    		Reporter.log("Send Travel To date for Season-C",true);
	    		
	    		BookingMask.sendPassenger3(utilityClass.readDataFromStringExcel(184, 3, "Sheet2"));
	    		Reporter.log("Select Number of passenger",true);
	    		Thread.sleep(500);
	  ...
	  
	   {
			  ...
			  String expectedPrice1 = utilityClass.readDataFromStringExcel(186, 1, "Sheet2");
			  Assert.assertEquals(ActualPrice1, expectedPrice1,"Test Case Failed as actual & expected Price are not matching");
			  Reporter.log("Validating Actual price for Season-C is "+BookingMask.getPriceFieldValue1("value")+" and Expected Price for Season-C is"+utilityClass.readDataFromStringExcel(186, 1, "Sheet2"),true);
			  
			  String ActualPrice2 = BookingMask.getPriceFieldValue2("value");
			  String expectedPrice2 = utilityClass.readDataFromStringExcel(186, 2, "Sheet2");
			  Assert.assertEquals(ActualPrice2, expectedPrice2,"Test Case Failed as actual & expected Price are not matching");
			  Reporter.log("Validating Actual price for season-C is "+BookingMask.getPriceFieldValue2("value")+" and Expected Price for Season-C is "+utilityClass.readDataFromStringExcel(186, 2, "Sheet2"),true); 
			  
			  String ActualPrice3 = BookingMask.getPriceFieldValue3("value");
			  String expectedPrice3 = utilityClass.readDataFromStringExcel(186, 3, "Sheet2");
			  Assert.assertEquals(ActualPrice3, expectedPrice3,"Test Case Failed as actual & expected Price are not matching");
			  Reporter.log("Validating Actual price for season-C is "+BookingMask.getPriceFieldValue3("value")+" and Expected Price for Season-C is "+utilityClass.readDataFromStringExcel(186, 3, "Sheet2"),true);   
	   }
