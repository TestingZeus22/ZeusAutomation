	...
	public class TCC27 extends baseClass
	{
		loginPage login;
		File myFile;
		...
		public void loginToApp() throws EncryptedDocumentException, IOException, InterruptedException
		{
			...
			Thread.sleep(9500);
	    		...
	    		BookingMask.sendTravelFromDate(utilityClass.readDataFromStringExcel(157, 4, "Sheet2"));
	    		Reporter.log("Send Travel from date",true);
	    		
	    		BookingMask.sendTravelToDate(utilityClass.readDataFromStringExcel(158, 4, "Sheet2"));
		        ...
		        BookingMask.ClearbookingActionfield();
	    		BookingMask.sendBookingAction(utilityClass.readDataFromStringExcel(141, 1, "Sheet2"));
	    		Reporter.log("change booking action to U",true);
	    	    Thread.sleep(1000);
	    	    
	    		BookingMask.clearNoOfPax();
	    		BookingMask.sendNoOfPax(utilityClass.readDataFromStringExcel(137, 5, "Sheet2"));
	    		...
	    		BookingMask.sendTravelFromDate2(utilityClass.readDataFromStringExcel(157, 4, "Sheet2"));
	    		Reporter.log("Send Travel from date",true);
	    		
	    		BookingMask.sendTravelToDate2(utilityClass.readDataFromStringExcel(158, 4, "Sheet2"));
	    		Reporter.log("Send Travel To date",true);
	   ...
	   @Test
	   public void validateTotalPrice() throws EncryptedDocumentException, IOException 
	  
	   {
		    String expectedPrice1 = utilityClass.readDataFromStringExcel(159, 4, "Sheet2");
			Assert.assertEquals(roomPrice1, expectedPrice1,"Test Case Failed as actual & expected Price are not matching");
			Reporter.log("Validating Actual price for Room1 is "+roomPrice1+" and Expected Price for Room1 is "+utilityClass.readDataFromStringExcel(159, 4, "Sheet2"),true);
			
			String expectedPrice2 = utilityClass.readDataFromStringExcel(159, 4, "Sheet2");
			Assert.assertEquals(roomPrice2, expectedPrice2,"Test Case Failed as actual & expected Price are not matching");
			Reporter.log("Validating Actual price for Room2 is "+roomPrice2+" and Expected Price for Room2 is "+utilityClass.readDataFromStringExcel(159, 4, "Sheet2"),true);
			
			String TotalPrice = BookingMask.getTotalPrice("value");
			String ExpectedTotalPrice = utilityClass.readDataFromStringExcel(160, 4, "Sheet2");
			Reporter.log("Validating Total price for both Room is "+BookingMask.getTotalPrice("value")+" and Expected Price for both room  is "+utilityClass.readDataFromStringExcel(160, 4, "Sheet2"),true);
	   }
	   @AfterMethod
