...
public class verifyCreateConfirmBooking_TC02 extends baseClass
{
	loginPage login;
	File myFile;
...
//		
      ...
      // Offer Defination Page
    		...
    		driver.findElement(By.xpath("(//ul[@class='jstree-children']//a)[30]")).click();
    		//driver.findElement(By.xpath("(//a[@class='jstree-anchor'])[29]")).click();
    		...
    		BookingMask.bookingActionFieldclear();
		...
		Thread.sleep(500);
		BookingMask.sendLastName(utilityClass.readDataFromStringExcel(31, 1, "Sheet3"));
		Thread.sleep(500);
		BookingMask.sendFirstName(utilityClass.readDataFromStringExcel(32, 1, "Sheet3"));
		Thread.sleep(500);
		BookingMask.sendCityName(utilityClass.readDataFromStringExcel(33, 1, "Sheet3"));
		Thread.sleep(500);
		BookingMask.sendZipCode(utilityClass.readDataFromStringExcel(34, 1, "Sheet3"));
		Thread.sleep(500);
		BookingMask.sendStreetNo(utilityClass.readDataFromStringExcel(35, 1, "Sheet3"));
		Thread.sleep(500);
		BookingMask.sendPhoneNum(utilityClass.readDataFromStringExcel(36, 1, "Sheet3"));
		Thread.sleep(500);
		BookingMask.sendEmail(utilityClass.readDataFromStringExcel(37, 1, "Sheet3"));
...
//       driver.findElement(By.xpath("//a[text()='SalesBooking']")).click();
//       Thread.sleep(2000);
//       driver.findElement(By.xpath("(//input[@type='text'])[6]")).sendKeys("IN014");
//       Thread.sleep(500);
//       driver.findElement(By.xpath("//label[@class='sb']")).click();
//       Thread.sleep(3000);
//       
   ...
   @Test
   public void validateReservationNoField() throws EncryptedDocumentException, IOException 
  
   {
	  String Actual = BookingMask.getValueOnReservationNO("value");
	 // String Actual = BookingMask.getPriceFieldValue("value");
	 // Object salesBooking = driver.findElement(By.xpath("//a[text()='SalesBooking']")).click();
	  String expected = utilityClass.readDataFromStringExcel(38, 1, "Sheet2");
	  Assert.assertEquals(Actual, expected,"Test Case Failed as actual & expected Reservation Number are not matching");
	  Reporter.log("Validating Actual Reservation Number "+BookingMask.getValueOnReservationNO("value")+" and Expected Price "+utilityClass.readDataFromStringExcel(38, 1, "Sheet3"),true);
