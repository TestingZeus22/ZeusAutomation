	...
	public class TCC39 extends baseClass
	{
		loginPage login;
		File myFile;
		...
		public void loginToApp() throws EncryptedDocumentException, IOException, InterruptedException
		{
	    		...
	    		utilityClass.implicitlyWaitInMillis(10000);
	    		bookingupdate.sendTravelTo1(utilityClass.readDataFromStringExcel(134, 3, "Sheet2"));
	    		Reporter.log("Send Travel To date of Season-G",true);
	    		BookingMask.clickOnSendbookingButton();
		        ...
		        try {
					...
					System.out.println("Not clicked on view list button");
				}
				Reporter.log("Clicked on ViewList",true);
				Thread.sleep(5000);
				//utilityClass.implicitlyWaitInMillis(10000); 
	   ...
	   @Test
	   public void validateReservationNoOnSalesList() throws EncryptedDocumentException, IOException 
	   {
			String expectedPrice = utilityClass.readDataFromStringExcel(135, 3, "Sheet2");
			Assert.assertEquals(ActualPrice, expectedPrice,"Test Case Failed as actual & expected Price are not matching");
			Reporter.log("Validating Actual price "+ActualPrice+" and Expected Price "+utilityClass.readDataFromStringExcel(135, 3, "Sheet2"),true);
