...
public class verifyTravelDateInBetweenSeasonC_TC82 extends baseClass {
	...
	public void loginToApp() throws EncryptedDocumentException, IOException, InterruptedException
	{
    		...
    		BookingMask.sendTravelFromDate(utilityClass.readDataFromStringExcel(167, 1, "Sheet2"));
    		Reporter.log("Send Travel from date for season-C",true);
    		
    		BookingMask.sendTravelToDate(utilityClass.readDataFromStringExcel(168, 1, "Sheet2"));
	    ...
	    public void validatePriceInBetweenSeasonC() throws EncryptedDocumentException, IOException 
	    {
		  ...
		  String expectedPrice = utilityClass.readDataFromStringExcel(169, 1, "Sheet2");
		  Assert.assertEquals(ActualPrice, expectedPrice,"Test Case Failed as actual & expected Price are not matching");
		  Reporter.log("Validating Actual price "+BookingMask.getPriceFieldValue1("value")+" and Expected Price "+utilityClass.readDataFromStringExcel(169, 1, "Sheet2"),true);
	    }
