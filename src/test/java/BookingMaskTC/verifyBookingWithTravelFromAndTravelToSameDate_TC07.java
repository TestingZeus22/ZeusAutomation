...
//    		Thread.sleep(9800);
    		...
    		BookingMask.sendTravelFromDate(utilityClass.readDataFromStringExcel(110, 1, "Sheet2"));
    		Reporter.log("Send Travel from date",true);
    		
    		BookingMask.sendTravelToDate(utilityClass.readDataFromStringExcel(111, 1, "Sheet2"));
    ...
    public void validateTravelFromAndTravelToSameDatePopUpMessageonBM() throws EncryptedDocumentException, IOException 
    {
	  ...
	  String expectedMessage = utilityClass.readDataFromStringExcel(109, 1, "Sheet2");
	  Assert.assertEquals(ActualMessage, expectedMessage,"Test Case Failed as actual & expected Text are not matching");
	  Reporter.log("Validating Actual Message "+BookingMask.getTravelFromDateLessThanTravelToDatePopUpMsg()+" and Expected Message "+utilityClass.readDataFromStringExcel(109, 1, "Sheet2"),true);
    }
