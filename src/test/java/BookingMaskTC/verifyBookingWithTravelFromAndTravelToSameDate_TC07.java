...
public class verifyBookingWithTravelFromAndTravelToSameDate_TC07 extends baseClass {
	...
	public void loginToApp() throws EncryptedDocumentException, IOException, InterruptedException
	{
      ...
      // Offer Defination Page
    		...
    		BookingMask.sendTravelToDate(utilityClass.readDataFromStringExcel(110, 1, "Sheet2"));
    ...
    public void validateTravelFromAndTravelToSameDatePopUpMessageonBM() throws EncryptedDocumentException, IOException 
    {
	  ...
	  String expectedMessage = utilityClass.readDataFromStringExcel(108, 1, "Sheet2");
	  Assert.assertEquals(ActualMessage, expectedMessage,"Test Case Failed as actual & expected Text are not matching");
	  Reporter.log("Validating Actual Message "+BookingMask.getTravelFromDateLessThanTravelToDatePopUpMsg()+" and Expected Message "+utilityClass.readDataFromStringExcel(108, 1, "Sheet2"),true);
    }
