	...
	public class verifyCreateBookingForFivePerson_TC37 extends baseClass
	{
		...
		public void loginToApp() throws EncryptedDocumentException, IOException, InterruptedException
		{
	    		...
	    		BookingMask.sendNoOfPax(utilityClass.readDataFromStringExcel(149, 4, "Sheet2"));
	    		...
	    		BookingMask.sendOccupancy(utilityClass.readDataFromStringExcel(150, 4, "Sheet2"));
	    		Reporter.log("Send Occupancy",true);
	    	
	    		BookingMask.sendTotalPax(utilityClass.readDataFromStringExcel(151, 4, "Sheet2"));
	   ...
	   public void validatePriceWithFivePerson() throws EncryptedDocumentException, IOException 
	  
	       {
			  ...
			  String expectedPrice = utilityClass.readDataFromStringExcel(153, 4, "Sheet2");
			  Assert.assertEquals(ActualPrice, expectedPrice,"Test Case Failed as actual & expected Price are not matching");
			  Reporter.log("Validating Actual price "+bookingUpdate.getPriceFieldValue1("value")+" and Expected Price "+utilityClass.readDataFromStringExcel(153, 4, "Sheet2"),true);
		    }
