	...
	public class TCC28 extends baseClass
	{
		loginPage login;
		File myFile;
		...
		public void loginToApp() throws EncryptedDocumentException, IOException, InterruptedException
		{
			...
			Thread.sleep(9500);
	    		...
	    		BookingMask.sendTravelFromDate2(utilityClass.readDataFromStringExcel(161, 4, "Sheet2"));
	    		Reporter.log("Send Modified Travel from date",true);
	    		
	    		BookingMask.sendTravelToDate2(utilityClass.readDataFromStringExcel(162, 4, "Sheet2"));
	  ...
	  
	   {
			...
			String expectedPrice2 = utilityClass.readDataFromStringExcel(163, 4, "Sheet2");
			Assert.assertEquals(roomPrice2, expectedPrice2,"Test Case Failed as actual & expected Price are not matching");
			Reporter.log("Validating Actual price for Room2 is "+roomPrice2+" and Expected Price for Room2 is "+utilityClass.readDataFromStringExcel(163, 4, "Sheet2"),true);
			
			String TotalPrice = BookingMask.getTotalPrice("value");
			String ExpectedTotalPrice = utilityClass.readDataFromStringExcel(164, 4, "Sheet2");
			Reporter.log("Validating Total price for both Room is "+BookingMask.getTotalPrice("value")+" and Expected Price for both room  is "+utilityClass.readDataFromStringExcel(164, 4, "Sheet2"),true);
	   }
	   @AfterMethod
