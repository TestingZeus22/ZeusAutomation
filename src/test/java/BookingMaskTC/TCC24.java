	...
	public class TCC24 extends baseClass
	{
		loginPage login;
		File myFile;
		...
		public void loginToApp() throws EncryptedDocumentException, IOException, InterruptedException
		{
			...
			Thread.sleep(9500); 
	    		...
	    		BookingMask.sendBookingAction(utilityClass.readDataFromStringExcel(51, 2, "Sheet3"));
	    		Thread.sleep(1000);
	    		bookingupdate.clearTravelFrom1();
	    		bookingupdate.sendTravelFrom1(utilityClass.readDataFromStringExcel(54, 2, "Sheet3"));
	    		Reporter.log("Send Modified Travel from date",true);
	    		utilityClass.implicitlyWaitInMillis(20000);
	    		bookingupdate.clearTravelTo1();
	    		bookingupdate.sendTravelTo1(utilityClass.readDataFromStringExcel(55, 2, "Sheet3"));
	   ...
	   public void validateErrorMessageForOutOfContractDates() throws EncryptedDocumentException, IOException 
	  
	   	{
		    ...
		    String expectedMessage = utilityClass.readDataFromStringExcel(56, 2, "Sheet3");
		    Assert.assertEquals(expectedMessage,ActualMessage, "TC failed as Actual message and expected message are not matching ");
		    Reporter.log("Validating Actual message "+BookingMask.getTravelToDateOutOfContractDateNotification()+" and Expected message "+utilityClass.readDataFromStringExcel(56, 2, "Sheet3"),true);
		}
