	...
	public class MultisalesLineBookingWithDifferentDatesAndMoreThanMaxStay_TC151 extends BaseClass
	{
		loginPage login;
		File myFile;
		...
		public void loginToApp() throws EncryptedDocumentException, IOException, InterruptedException
		{
	    		...
	    		BookingMask.sendTravelFromDate(UtilityClass.readDataFromStringExcel(27, 1, "Sheet3"));
	    		Reporter.log("Send Travel from date",true);
	    		
	    		BookingMask.sendTravelToDate(UtilityClass.readDataFromStringExcel(28, 1, "Sheet3"));
	    		...
	    		BookingMask.sendTravelFromDate2(UtilityClass.readDataFromStringExcel(27, 2, "Sheet3"));
	    		Reporter.log("Send Travel from date for Season-C",true);
	    		
	    		BookingMask.sendTravelToDate2(UtilityClass.readDataFromStringExcel(28, 2, "Sheet3"));
	    		...
	    		BookingMask.sendTravelFromDate3(UtilityClass.readDataFromStringExcel(27, 3, "Sheet3"));
	    		Reporter.log("Send Travel from date",true);
	    		
	    		BookingMask.sendTravelToDate3(UtilityClass.readDataFromStringExcel(28, 3, "Sheet3"));
	    		Reporter.log("Send Travel To date ",true);
	   ...
	   @Test
	   public void validateErrorMsgwithDifferentDatesAndMaxStay() throws EncryptedDocumentException, IOException 
	   {
