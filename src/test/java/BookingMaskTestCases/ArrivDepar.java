...
public class ArrivDepar extends BaseClass {
	loginPage login;
	File myFile;
	...
	public void loginToApp() throws EncryptedDocumentException, IOException, InterruptedException
	{
		...
		// TODO: handle exception
         ...
         Thread.sleep(500);
         arrivalDepar.clickOnarrivalDaysRoom1SelectAllCheckBox1();
         Thread.sleep(500);
         arrivalDepar.clickOnDepartureDaysRoom1SelectAllCheckBox1();
         Thread.sleep(500);
