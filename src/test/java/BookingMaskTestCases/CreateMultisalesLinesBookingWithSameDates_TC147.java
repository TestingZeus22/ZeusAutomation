...
import utility.UtilityClass;
	...
	public class CreateMultisalesLinesBookingWithSameDates_TC147 extends BaseClass
	{
		loginPage login;
		File myFile;
		...
		public void loginToApp() throws EncryptedDocumentException, IOException, InterruptedException
		{
	    		...
	    		BookingMask.sendTravelFromDate(UtilityClass.readDataFromStringExcel(10, 1, "Sheet3"));
	    		Reporter.log("Send Travel from date",true);
	    		
	    		BookingMask.sendTravelToDate(UtilityClass.readDataFromStringExcel(11, 1, "Sheet3"));
	    		...
	    		BookingMask.sendTravelFromDate2(UtilityClass.readDataFromStringExcel(10, 2, "Sheet3"));
	    		Reporter.log("Send Travel from date",true);
	    		
	    		BookingMask.sendTravelToDate2(UtilityClass.readDataFromStringExcel(11, 2, "Sheet3"));
	    		Reporter.log("Send Travel To date",true);
	    		...
	    		BookingMask.sendTravelFromDate3(UtilityClass.readDataFromStringExcel(10, 3, "Sheet3"));
	    		Reporter.log("Send Travel from date",true);
	    		
	    		BookingMask.sendTravelToDate3(UtilityClass.readDataFromStringExcel(11, 3, "Sheet3"));
	    		Reporter.log("Send Travel To date",true);
	   ...
	   @Test
	   public void validateBookingForThreeRoomsWithSameDateAndPrice() throws EncryptedDocumentException, IOException 
	  
	   {
			...
			String expectedPrice2 = UtilityClass.readDataFromStringExcel(12, 2, "Sheet3");
			Assert.assertEquals(roomPrice2, expectedPrice2,"Test Case Failed as actual & expected Price are not matching");
			Reporter.log("Validating Actual price for Room2 is "+roomPrice2+" and Expected Price for Room2 is "+UtilityClass.readDataFromStringExcel(12, 2, "Sheet3"),true); 
			String expectedPrice3 = UtilityClass.readDataFromStringExcel(12, 3, "Sheet3");
			Assert.assertEquals(roomPrice3, expectedPrice3,"Test Case Failed as actual & expected Price are not matching");
			Reporter.log("Validating Actual price for Room3 is "+roomPrice3+" and Expected Price for Room3 is "+UtilityClass.readDataFromStringExcel(12, 3, "Sheet3"),true);   
   }
