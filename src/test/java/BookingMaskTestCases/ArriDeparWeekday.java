...
import POM.arrivalDepartureConditionsPage;
...
public class ArriDeparWeekday extends BaseClass {
	loginPage login;
	File myFile;
	...
	pricePage price;
	arrivalDepartureConditionsPage arrivalDepar;
	...
	public void launchBrowser(){
		...
		arrivalDepar = new arrivalDepartureConditionsPage (driver);
	}
	...
	public void loginToApp() throws EncryptedDocumentException, IOException, InterruptedException
	{
		...
		// TODO: handle exception
         ...
         Thread.sleep(3000);
         WebElement dropdown=driver.findElement(By.xpath("//select[@id='adModel_RoomID_4']"));
         ...
         Thread.sleep(500);
         arrivalDepar.clickOnarrivalDaysRoom1MondayCheckBox2();
         Thread.sleep(500);
         arrivalDepar.clickOnarrivalDaysRoom1TuesdayCheckBox3();
         Thread.sleep(500);
         arrivalDepar.clickOnarrivalDaysRoom1WednesdayCheckBox4();
         Thread.sleep(500);
         arrivalDepar.clickOnDepartureDaysRoom1ThursdayCheckBox5();
         Thread.sleep(500);
         arrivalDepar.clickOnDepartureDaysRoom1FridayCheckBox6();
         Thread.sleep(500);
         arrivalDepar.clickOnDepartureDaysRoom1SaturdayCheckBox7();
         Thread.sleep(500);
         arrivalDepar.sendMinStayForRoom1(UtilityClass.readDataFromStringExcel(39, 3, "Sheet2"));
         Thread.sleep(500);
         arrivalDepar.sendMaxStayForRoom1(UtilityClass.readDataFromStringExcel(40, 3, "Sheet2"));
         Thread.sleep(500);
    ...
    public void validatePriceFieldWithBA() throws EncryptedDocumentException, IOException 
    {
	  ...
	  Reporter.log("Validating Actual price is"+BookingMask.getPriceFieldValue1("value")+" and Expected Price is "+UtilityClass.readDataFromStringExcel(522, 2, "Sheet2"),true);
    }
