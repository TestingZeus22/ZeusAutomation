	...
	public class VerifyCreateBookingWithTwoPerson_TC33 extends BaseClass
	{
		loginPage login;
		File myFile;
	   ...
	   @Test
	   public void validatePriceWithTwoPerson() throws EncryptedDocumentException, IOException 
