...
public class CreateWeekdaysAll extends BaseClass {
	loginPage login;
	File myFile;
...
//        UtilityClass.listBoxHandlingUsingByText("801 room1", price.room1Dropdown1());
//        Reporter.log("Select another room from the dropdown");
        
        // Weekdays TC89 TO TC92  (Facing issue with Weekday Sunday because it is invisible to selenium)
        
       /* UtilityClass.listBoxHandlingUsingByText("802 room2", price.room2Dropdown2());
        Reporter.log("Select another room from the dropdown");
        
        price.clickOnRoom2CheckBox1AllDay();
        Reporter.log("Clicked on all day checkBox to uncheck AllDays");
        UtilityClass.implicitlyWaitInMillis(2000);
        price.clickOnRoom2CheckBox2Monday();
        UtilityClass.implicitlyWaitInMillis(2000);
        price.clickOnRoom2CheckBox3Tuesday();
        UtilityClass.implicitlyWaitInMillis(2000);
        price.clickOnRoom2CheckBox4Wednesday();
        UtilityClass.implicitlyWaitInMillis(2000);
        price.clickOnRoom2CheckBox5Thursday();
        UtilityClass.implicitlyWaitInMillis(2000);
        price.clickOnRoom2CheckBox6Friday();
        UtilityClass.implicitlyWaitInMillis(2000);
        ...
        UtilityClass.listBoxHandlingUsingByText("802 room2", price.room2Dropdown2());
        Reporter.log("Select room from the dropdown");
        UtilityClass.implicitlyWaitInMillis(2000);
        price.clickOnRoom3CheckBox1AllDay();
        Reporter.log("Clicked on all day checkBox to uncheck AllDays");
        UtilityClass.implicitlyWaitInMillis(2000);
        price.clickOnRoom3CheckBox7Saturday();
        Thread.sleep(1000);
        price.clickOnRoom3CheckBox8Sunday();
        UtilityClass.implicitlyWaitInMillis(2000); */
        
        // Weekdays TC93 TO TC97
        ...
        //Weekdays TC122 TO TC 125 ( For checkbox selection for Sunday the element is hide within season table)
       ...
       UtilityClass.listBoxHandlingUsingByText("802 room2", price.room2Dropdown2());
        ...
        price.clickOnRoom2CheckBox8Sunday();
...
//        Reporter.log("Clicked on all day checkBox to uncheck AllDays");
//        UtilityClass.implicitlyWaitInMillis(2000);
//        price.clickOnRoom3CheckBox3Tuesday();
//        Reporter.log("Clicked on Tuesday checkBox");
//        UtilityClass.implicitlyWaitInMillis(2000);
//        price.clickOnRoom3CheckBox5Thursday();
//        Reporter.log("Clicked on Thursday checkBox");
//        UtilityClass.implicitlyWaitInMillis(2000);
//        price.clickOnRoom3CheckBox7Saturday();
//        Reporter.log("Clicked on saturday checkbox");
//        UtilityClass.implicitlyWaitInMillis(2000);
//        price.clickOnRoom3CheckBox2Monday();
//        Reporter.log("Clicked on Monday checkbox");
//        UtilityClass.implicitlyWaitInMillis(2000);
//        Thread.sleep(500);
...
//        Thread.sleep(300);     
       ...
       // Offer Defination Page
    	   ...
    	   // calculationSetting.clickOnRoom1(); 
    		...
    		@Test  (enabled=false)// TC93 
    		public void validatePriceFieldWithBookingInquiry() throws EncryptedDocumentException, IOException, InterruptedException {
    		...
    		UtilityClass.implicitlyWaitInMillis(1000);
    		BookingMask.sendRoomCode(UtilityClass.readDataFromStringExcel(28, 2, "Sheet2"));
    		...
    		@Test  (enabled=false)// TC98
    		public void validatePriceFieldWithBookingInquiryy() throws EncryptedDocumentException, IOException, InterruptedException {
    		UtilityClass.listBoxHandlingUsingByText("TFT1", BookingMask.TravelTypeDropDownMethod());
    		Reporter.log("Select TFT1 in TravelType dropdownList",true);
    		Thread.sleep(1000);
    		UtilityClass.listBoxHandlingUsingByText("HK004 - (TEST)", BookingMask.productCodeDropDownMethod());
    		...
    		@Test  (enabled=false)// TC102
    		public void validatePriceFieldWithBookingInquiryyyy() throws EncryptedDocumentException, IOException, InterruptedException {
    		UtilityClass.listBoxHandlingUsingByText("TFT1", BookingMask.TravelTypeDropDownMethod());
    		Reporter.log("Select TFT1 in TravelType dropdownList",true);
    		Thread.sleep(1000);
    		UtilityClass.listBoxHandlingUsingByText("HK004 - (TEST)", BookingMask.productCodeDropDownMethod());
    		...
    		BookingMask.sendTotalPax(UtilityClass.readDataFromStringExcel(73, 1, "Sheet2"));
    		Reporter.log("Send bookinglines ",true);
    		BookingMask.sendTravelFromDate(UtilityClass.readDataFromStringExcel(429, 2, "Sheet2"));
    		Reporter.log("Send Travel from date",true);
    		BookingMask.sendTravelToDate(UtilityClass.readDataFromStringExcel(430, 2, "Sheet2"));
    		Reporter.log("Send Travel To date",true);
    		driver.findElement(By.id("bookinglines_PassengerNo_2")).sendKeys("1-2");
    		Reporter.log("Select Number of passenger",true);
    		Thread.sleep(2000); 
            ...
            String ActualPrice = BookingMask.getPriceFieldValue1("value");
            String expectedPrice = UtilityClass.readDataFromStringExcel(432, 2, "Sheet2");
            Assert.assertEquals(ActualPrice, expectedPrice,"Test Case Failed as actual & expected Price are not matching");
    		...
    		@Test  (enabled=false)// TC108
    		public void validatePriceFieldWithBookingInquiryyyyy() throws EncryptedDocumentException, IOException, InterruptedException {
    		UtilityClass.listBoxHandlingUsingByText("TFT1", BookingMask.TravelTypeDropDownMethod());
    		Reporter.log("Select TFT1 in TravelType dropdownList",true);
    		Thread.sleep(1000);
    		UtilityClass.listBoxHandlingUsingByText("HK004 - (TEST)", BookingMask.productCodeDropDownMethod());
    		...
    		@Test  (enabled=false)// TC113
    		public void validatePriceFieldWithBookingInquirryyyyy() throws EncryptedDocumentException, IOException, InterruptedException {
    		UtilityClass.listBoxHandlingUsingByText("TFT1", BookingMask.TravelTypeDropDownMethod());
    		Reporter.log("Select TFT1 in TravelType dropdownList",true);
    		Thread.sleep(1000);
    		UtilityClass.listBoxHandlingUsingByText("HK004 - (TEST)", BookingMask.productCodeDropDownMethod());
    		...
    		@Test  (enabled=false)// TC118
    		public void validatePriceFieldWithBookingInqtuirryyyyy() throws EncryptedDocumentException, IOException, InterruptedException {
    		UtilityClass.listBoxHandlingUsingByText("TFT1", BookingMask.TravelTypeDropDownMethod());
    		Reporter.log("Select TFT1 in TravelType dropdownList",true);
    		Thread.sleep(1000);
    		UtilityClass.listBoxHandlingUsingByText("HK004 - (TEST)", BookingMask.productCodeDropDownMethod());
    		...
    		@Test  (priority=1)// TC122
    		public void validatePriceFieldWithBookingInqtuirryyytyy() throws EncryptedDocumentException, IOException, InterruptedException {
    		UtilityClass.listBoxHandlingUsingByText("TFT1", BookingMask.TravelTypeDropDownMethod());
    		Reporter.log("Select TFT1 in TravelType dropdownList",true);
    		Thread.sleep(1000);
    		UtilityClass.listBoxHandlingUsingByText("HK004 - (TEST)", BookingMask.productCodeDropDownMethod());
