	...
	public class createBookingForTwoPersonAndTwoRoom_TC34 extends baseClass
	{
		loginPage login;
		File myFile;
	   ...
	   @Test
	   public void validatePriceForTwoPersonTwoRooms() throws EncryptedDocumentException, IOException 
	   {
