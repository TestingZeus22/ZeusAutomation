...
public class offerDefination {
	...
	@FindBy (xpath ="(//input[@type='text'])[1]") private WebElement TBMcode;
	@FindBy (id ="chkProdID") private WebElement checkBox;
	@FindBy (xpath = "//a[@class='btn-shadow btn btn-primary']") private WebElement saveButton;

	
	public offerDefination(WebDriver driver)
	{
