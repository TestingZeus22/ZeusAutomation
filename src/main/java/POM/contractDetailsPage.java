...
public class contractDetailsPage {
	...
	@FindBy (id ="contractname") private WebElement contractNameField;
	@FindBy (id ="currencyid") private WebElement currencyDropdown;
	@FindBy (id ="ContractSeasonType") private WebElement contractSeasonTypeDropdown;	
	...
	@FindBy (xpath ="//input[@id='additionaldoc']") private WebElement additionalDocumentcheckBox;
	...
	@FindBy (xpath ="//span[@class='multiselect-selected-text']") private WebElement distributorCheckBox;
	@FindBy (xpath ="//li[@class='multiselect-item multiselect-all']") private WebElement multiselectDistributorCheckBox;
	...
	{
		WebElement Element = contractSeasonTypeDropdown;
		return Element;
	}
...

   {
	...
	public void clickOnDistributorCheckBox()
	{
		distributorCheckBox.click();
	}
	
	public void clickOnMultiselectDistributorCheckBox()
	{
		multiselectDistributorCheckBox.click();
	}
